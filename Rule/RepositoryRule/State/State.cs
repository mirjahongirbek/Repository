    ...
    public static class State
    {
        ...
        public static T ConvertDictionary<T>(this Dictionary<string, object> model)
        {
            ...
            foreach (var i in model)
            {
                ...
                if (props != null) props.SetValue(obj, i.Value);
            }
            ...
            where T : class, IUserDevice<TKey>
        {
            ...
            foreach (var field in userTip.GetProperties())
            {
                ...
                if (field.Name == "Id" && attr == null) claims.Add(new Claim(field.Name, user.Id.ToString()));
        ...
        public static PropsAttribute GetProps(this PropertyInfo i)
        {
            var attribute = i.GetCustomAttribute<PropsAttribute>();
            if (attribute == null && i.GetGetMethod().IsVirtual) return null;
            ...
            if (foregnKey != null) attr.ForeignTable = attr.ForeignTable ?? foregnKey.Name;
            ...
            if (require != null) attr.Required = true;
            return attr;
        }
        //TODO change JWT
