...
namespace RepositoryRule.Base
{
        ...
        where T : IEntity<TKey>
    {
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        T GetFirst(Expression<Func<T, bool>> expression, [CallerLineNumber] int lineNumber = 0,
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task<T> GetFirstAsync(Expression<Func<T, bool>> expression, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task AddRangeAsync(List<T> models, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task UpdateManyAsync(List<T> models, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="lineNumber"></param>
        /// <param name="caller"></param>
        T Delate(T model, [CallerLineNumber] int lineNumber = 0, [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task<T> DelateAsync(T model, [CallerLineNumber] int lineNumber = 0, [CallerMemberName] string caller = null);

        ///
        bool DeleteMany(Expression<Func<T, bool>> expression, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task<bool> DeleteManyAsync(Expression<Func<T, bool>> expression, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        IEnumerable<T> Find(Expression<Func<T, bool>> keySelector, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        IEnumerable<T> Find(string field, string value, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        IEnumerable<T> Find(string field, string value, int offset, int limit, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        IEnumerable<T> FindReverse(Expression<Func<T, bool>> selector, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task<IEnumerable<T>> FindAsync(Expression<Func<T, bool>> keySelector, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        Task<IEnumerable<T>> FindAsync(string field, string value, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        long Count(Expression<Func<T, bool>> expression, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        long Count(string field, string value, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        T CalProcedure(string functinname, object[] item, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        IEnumerable<T> CallProcedure(string str, [CallerLineNumber] int lineNumber = 0,
            [CallerMemberName] string caller = null);
